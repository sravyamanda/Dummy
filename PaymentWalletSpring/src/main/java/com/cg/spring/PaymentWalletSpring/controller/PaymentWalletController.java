...
public class PaymentWalletController {
	...
	public void withdrawMoney(@PathVariable String mobileNumber, @PathVariable Double withdrawableAmount) throws InsufficientBalanceException  {
	...
	public void fundTransfer(@PathVariable String SmobileNumber, @PathVariable String RecmobileNumber,
			@PathVariable double transferableAmount) throws InsufficientBalanceException {
